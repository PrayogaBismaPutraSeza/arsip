<?php
    ...
    if (!($tgl_masuk=='') and !($nomorurut_suratmasuk  =='') and !($nomor_suratmasuk =='') and !($tgl_surat =='')  and !($perihal_suratmasuk =='') and !($operator =='') and !($tanggal_entry =='') and   
		...
		$sql = "INSERT INTO tb_suratmasuk(tanggalmasuk_suratmasuk, nomorurut_suratmasuk, nomor_suratmasuk, tanggalsurat_suratmasuk, kategori, perihal_suratmasuk, file_suratmasuk, operator, tanggal_entry)
				values ('$tgl_masuk',  '$nomorurut_suratmasuk ', '$nomor_suratmasuk', '$tgl_surat',  '$kategori', '$perihal_suratmasuk', '$nama_baru', '$operator', '$tanggal_entry')";
